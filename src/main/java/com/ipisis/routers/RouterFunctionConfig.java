package com.ipisis.routers;

import com.ipisis.handlers.SimpleHandlerFunction;
...
public class RouterFunctionConfig {
    ...
    @Bean
    public RouterFunction<ServerResponse> router(SimpleHandlerFunction handlerFunction){
